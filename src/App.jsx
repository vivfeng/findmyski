...
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbx3UtP-QXH2jEa65D0v2jINu-5kWfIS6C-iodI2t6FGqd-mgom7uGaYMLCjd9rz5a_j/exec";
...
const SYSTEM_PROMPT = `You are an expert ski advisor with deep knowledge of 2025/2026 ski models, drawing from OutdoorGearLab, SKI Magazine, Outside, Switchback Travel, Blister Review, and Powder Magazine.
            ...
            <div key="intro" style={{animation:"rise 0.5s cubic-bezier(0.4,0,0.2,1)"}}>
              <div style={{paddingTop:"5rem",paddingBottom:"3rem",borderBottom:`1px solid ${T.rule}`}}>
                ...
                <p style={{fontSize:"1rem",color:T.inkMid,margin:"0 0 2.5rem",lineHeight:1.7,fontWeight:300,maxWidth:480}}>
                  Seven questions. One precise recommendation: exact model, length, width, and where to buy it. Built on real tester data from six expert sources.
                </p>
              ...
              <div style={{paddingTop:"2.5rem",paddingBottom:"2.5rem",borderBottom:`1px solid ${T.rule}`}}>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:"1.25rem"}}>
                  {[
                    ...
                    ["05","Take it with you","Text your recommendation to yourself. Model, specs, price, and trusted retailers, ready for the shop."],
                  ].map(([num,title,b])=>(
